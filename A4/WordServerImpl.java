 ...
 * WordServerImpl
 * 
 * This class implements the WordServer interface and provides functionalities 
 * to check, remove, and create words in a word list, as well as fetch random 
 * words based on specific conditions
 * */
